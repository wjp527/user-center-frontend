export default {
  ...
  'pages.login.userAccount.placeholder': 'nama pengguna: admin atau user',
  'pages.login.userAccount.required': 'Nama pengguna harus diisi!',
  'pages.login.userPassword.placeholder': 'kata sandi: ant.design',
  'pages.login.userPassword.required': 'Kata sandi harus diisi!',
