export default {
  ...
  'pages.login.userAccount.placeholder': 'ユーザー名：adminまたはuser',
  'pages.login.userAccount.required': 'ユーザー名を入力してください！',
  'pages.login.userPassword.placeholder': 'パスワード：ant.design',
  'pages.login.userPassword.required': 'パスワードを入力してください！',
