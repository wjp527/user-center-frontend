export default {
  ...
  'pages.login.userAccount.placeholder': '用戶名: admin or user',
  'pages.login.userAccount.required': '用戶名是必填項！',
  'pages.login.userPassword.placeholder': '密碼: ant.design',
  'pages.login.userPassword.required': '密碼是必填項！',
