export default {
  ...
  'pages.login.userAccount.placeholder': 'Usuário: admin or user',
  'pages.login.userAccount.required': 'Por favor insira seu usuário!',
  'pages.login.userPassword.placeholder': 'Senha: ant.design',
  'pages.login.userPassword.required': 'Por favor insira sua senha!',
