export default {
  ...
  'pages.login.userAccount.placeholder': 'نام کاربری: مدیر یا کاربر',
  'pages.login.userAccount.required': 'لطفا نام کاربری خود را وارد کنید!',
  'pages.login.userPassword.placeholder': 'رمز عبور: ant.design',
  'pages.login.userPassword.required': 'لطفاً رمز ورود خود را وارد کنید!',
