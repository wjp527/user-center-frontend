export default {
  ...
  'pages.login.userAccount.placeholder': 'ব্যবহারকারীর নাম: admin or user',
  'pages.login.userAccount.required': 'আপনার ব্যবহারকারীর নাম ইনপুট করুন!',
  'pages.login.userPassword.placeholder': 'পাসওয়ার্ড: ant.design',
  'pages.login.userPassword.required': 'আপনার পাসওয়ার্ড ইনপুট করুন!',
